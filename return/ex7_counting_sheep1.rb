...
# Incorrect. Should have been 0 through 5, each on their own line in ascending order

# I didn't know the behavior of the Interger#times method and its return value
