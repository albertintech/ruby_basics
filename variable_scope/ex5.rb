...
# I ain't guessing without know the rules in these here parts partner!

# Print results: Xyzzy. So it would appear this is another tricky bit of reasoning to learn.
